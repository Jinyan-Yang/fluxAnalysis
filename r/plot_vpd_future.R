...
plot.vpd.dis.func(hiD.period.ls,forest.index = crop.index,col =  col.df$iris[2])
legend('topleft',legend = c('(a) croplands'),bty='n')
abline(v = 6.25 ,col='grey')
abline(v = 6.25+0.7301*2   ,col='red')

plot.vpd.dis.func(hiD.period.ls,forest.index = forest.index,col =  col.df$iris[4])
legend('topleft',legend = c('(b) forests'),bty='n')
abline(v = 6.25 ,col='grey')
abline(v = 6.25- 0.9894   ,col='red')

plot.vpd.dis.func(hiD.period.ls,forest.index = sav.index,col =  col.df$iris[5])
legend('topleft',legend = c('(c) savana'),bty='n')
abline(v = 6.25 ,col='grey')
abline(v = 6.25+0.7301*2   ,col='red')

plot.vpd.dis.func(hiD.period.ls,forest.index = grass.index,col =  col.df$iris[1])
legend('topleft',legend = c('(d) grasslands'),bty='n')
abline(v = 6.25 ,col='grey')
abline(v = 6.25- 0.9894   ,col='red')

plot.vpd.dis.func(hiD.period.ls,forest.index = shrub.index,col =  col.df$iris[3])
